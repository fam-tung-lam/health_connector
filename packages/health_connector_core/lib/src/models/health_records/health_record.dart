...
part 'exercise/exercise_session_state_transition_type.dart';
...
part 'peak_expiratory_flow_rate_record.dart';
...
part 'events/headphone_audio_exposure_event_record.dart';
...
part 'walking/device_placement_side.dart';
part 'walking/walking_asymmetry_percentage_record.dart';
part 'walking/walking_double_support_percentage_record.dart';
part 'walking/walking_step_length_record.dart';
