...
part 'heart_rate/heartbeat_series_data_type.dart';
...
sealed class HealthDataType<R extends HealthRecord, U extends MeasurementUnit>
  ...
  /// Heartbeat series data type.
  ///
  /// Represents a series of individual heartbeats (R-R intervals) measured over
  /// a time interval. This data stores the precise timing of every single
  /// heartbeat, primarily used to calculate Heart Rate Variability (HRV) and
  /// detect irregularities.
  ///
  /// Unlike [heartRateSeries], which stores the *frequency* of beats (BPM),
  /// this data type stores the precise *timing* of each heartbeat.
  @sinceV3_7_0
  @supportedOnAppleHealth
  static const heartbeatSeries = HeartbeatSeriesDataType();
