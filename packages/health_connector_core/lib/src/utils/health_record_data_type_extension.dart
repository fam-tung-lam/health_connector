...
extension HealthRecordDataTypeExtension on HealthRecord {
  ...
  HealthDataType<HealthRecord, MeasurementUnit> get dataType {
    return switch (this) {
      ...
      HeartbeatSeriesRecord _ => HealthDataType.heartbeatSeries,
      ...
      MenstruationPeriodRecord _ => HealthDataType.menstruationPeriod,
      ...
      BasalMetabolicRateRecord _ => HealthDataType.basalMetabolicRate,
      ...
      PeakExpiratoryFlowRateRecord _ => HealthDataType.peakExpiratoryFlowRate,
