...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.environmentalAudioExposure;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('environmental_audio_exposure'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<EnvironmentalAudioExposureDataType>());
