...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.peripheralPerfusionIndex;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('peripheral_perfusion_index'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<PeripheralPerfusionIndexDataType>());
