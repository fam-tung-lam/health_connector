...
void main() {
  group(
    'SleepStageDataType',
    () {
      const dataType = HealthDataType.sleepStageRecord;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('sleep_stage'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<SleepStageDataType>());
      ...
      test(
        ...
        () {
          expect(
            dataType.category,
            equals(HealthDataTypeCategory.sleep),
          );
        },
      );
    },
