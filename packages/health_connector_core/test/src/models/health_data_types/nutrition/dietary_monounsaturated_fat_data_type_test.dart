...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.dietaryMonounsaturatedFat;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('dietary_monounsaturated_fat'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<DietaryMonounsaturatedFatDataType>());
