...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.dietaryTotalCarbohydrate;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('dietary_total_carbohydrate'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<DietaryTotalCarbohydrateDataType>());
