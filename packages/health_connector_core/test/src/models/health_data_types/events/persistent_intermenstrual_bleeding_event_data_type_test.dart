...
void main() {
  group('PersistentIntermenstrualBleedingEventDataType', () {
    const dataType = HealthDataType.persistentIntermenstrualBleedingEvent;

    test('has correct id', () {
      expect(dataType.id, 'persistent_intermenstrual_bleeding_event');
    });
    test(
      'type and capabilities are correctly defined',
      () {
        expect(dataType, isA<PersistentIntermenstrualBleedingEventDataType>());
