...
void main() {
  group('ProlongedMenstrualPeriodEventDataType', () {
    const dataType = HealthDataType.prolongedMenstrualPeriodEvent;

    test('has correct id', () {
      expect(dataType.id, 'prolonged_menstrual_period_event');
    });
    test(
      'type and capabilities are correctly defined',
      () {
        expect(dataType, isA<ProlongedMenstrualPeriodEventDataType>());
