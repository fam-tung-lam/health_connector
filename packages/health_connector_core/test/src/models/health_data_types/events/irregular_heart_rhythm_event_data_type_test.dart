...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.irregularHeartRhythmEvent;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('irregular_heart_rhythm_event'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<IrregularHeartRhythmEventDataType>());
