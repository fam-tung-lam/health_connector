...
void main() {
  group('InfrequentMenstrualCycleEventDataType', () {
    const dataType = HealthDataType.infrequentMenstrualCycleEvent;

    test('has correct id', () {
      expect(dataType.id, 'infrequent_menstrual_cycle_event');
    });
    test(
      'type and capabilities are correctly defined',
      () {
        expect(dataType, isA<InfrequentMenstrualCycleEventDataType>());
