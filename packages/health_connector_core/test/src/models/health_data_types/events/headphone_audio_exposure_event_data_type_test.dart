...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.headphoneAudioExposureEvent;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('headphone_audio_exposure_event'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<HeadphoneAudioExposureEventDataType>());
