...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.lowCardioFitnessEvent;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('low_cardio_fitness_event'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<LowCardioFitnessEventDataType>());
