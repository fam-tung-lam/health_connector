...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.peakExpiratoryFlowRate;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('peak_expiratory_flow_rate'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<PeakExpiratoryFlowRateDataType>());
