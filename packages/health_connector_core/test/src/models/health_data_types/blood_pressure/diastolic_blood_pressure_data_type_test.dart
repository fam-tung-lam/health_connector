...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.diastolicBloodPressure;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('diastolic_blood_pressure'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<DiastolicBloodPressureDataType>());
