...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.walkingSteadinessEvent;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('walking_steadiness_event'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<WalkingSteadinessEventDataType>());
