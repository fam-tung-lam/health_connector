...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.skinTemperatureDeltaSeries;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('skin_temperature'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<SkinTemperatureDeltaSeriesDataType>());
