...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.forcedExpiratoryVolume;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('forced_expiratory_volume'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<ForcedExpiratoryVolumeDataType>());
