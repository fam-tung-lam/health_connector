...
void main() {
  group(
    ...
    () {
      const dataType = HealthDataType.headphoneAudioExposure;
      test(
        'has correct id',
        () {
          expect(dataType.id, equals('headphone_audio_exposure'));
        },
      );
      ...
      test(
        ...
        () {
          expect(dataType, isA<HeadphoneAudioExposureDataType>());
