...
class MenstruationFlowRecordDto {
  ...
  static MenstruationFlowRecordDto decode(Object result) {
    result as List<Object?>;
    return MenstruationFlowRecordDto(
      id: result[0] as String?,
      time: result[1]! as int,
      flow: result[2] as MenstrualFlowDto?,
      metadata: result[3] as MetadataDto?,
      zoneOffsetSeconds: result[4] as int?,
    );
  }
...
class MenstruationPeriodRecordDto extends HealthRecordDto {
  ...
  List<MenstruationFlowRecordDto?> samples;
  ...
  static MenstruationPeriodRecordDto decode(Object result) {
    ...
    return MenstruationPeriodRecordDto(
      ...
      samples: (result[4] as List<Object?>?)!
          .cast<MenstruationFlowRecordDto?>(),
      startZoneOffsetSeconds: result[5] as int?,
      endZoneOffsetSeconds: result[6] as int?,
    );
  }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(211);
      writeValue(buffer, value.encode());
    } else if (value is MenstruationFlowRecordDto) {
      buffer.putUint8(212);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 212:
        return MenstruationFlowRecordDto.decode(readValue(buffer)!);
      case 213:
