...
/// Represents an environmental audio exposure event record for platform
/// transfer.
...
/// Represents a headphone audio exposure event record for platform transfer.
class HeadphoneAudioExposureEventRecordDto extends HealthRecordDto {
...
/// Represents an environmental audio exposure record for platform transfer.
class EnvironmentalAudioExposureRecordDto extends HealthRecordDto {
...
/// Represents an irregular menstrual cycle event record for platform transfer.
class IrregularMenstrualCycleEventRecordDto extends HealthRecordDto {
  IrregularMenstrualCycleEventRecordDto({
    required this.id,
    required this.startTime,
    required this.endTime,
    required this.metadata,
  ...
  /// Start time of the event in milliseconds since epoch (UTC).
  final int startTime;

  /// End time of the event in milliseconds since epoch (UTC).
  final int endTime;
