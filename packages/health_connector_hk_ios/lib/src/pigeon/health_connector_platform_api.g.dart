...
class MenstrualCycleRecordDto extends HealthRecordDto {
  ...
  static MenstrualCycleRecordDto decode(Object result) {
    result as List<Object?>;
    return MenstrualCycleRecordDto(
      ...
      isStartOfCycle: result[5]! as bool,
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! MenstrualCycleRecordDto || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(238);
      writeValue(buffer, value.encode());
    } else if (value is MenstrualCycleRecordDto) {
      buffer.putUint8(239);
      writeValue(buffer, value.encode());
    } else {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 239:
        return MenstrualCycleRecordDto.decode(readValue(buffer)!);
      default:
