...
class HeartbeatSampleDto {
  ...
  static HeartbeatSampleDto decode(Object result) {
    result as List<Object?>;
    return HeartbeatSampleDto(
      offsetMilliseconds: result[0]! as int,
      precededByGap: result[1]! as bool,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! HeartbeatSampleDto || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class HeartbeatSeriesRecordDto extends HealthRecordDto {
  ...
  List<HeartbeatSampleDto> samples;
  ...
  static HeartbeatSeriesRecordDto decode(Object result) {
    result as List<Object?>;
    return HeartbeatSeriesRecordDto(
      ...
      endTime: result[2]! as int,
      metadata: result[3]! as MetadataDto,
      samples: (result[4] as List<Object?>?)!.cast<HeartbeatSampleDto>(),
      startZoneOffsetSeconds: result[5] as int?,
      endZoneOffsetSeconds: result[6] as int?,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! HeartbeatSeriesRecordDto ||
        other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(234);
      writeValue(buffer, value.encode());
    } else if (value is HeartbeatSampleDto) {
      buffer.putUint8(235);
      writeValue(buffer, value.encode());
    } else if (value is HeartbeatSeriesRecordDto) {
      buffer.putUint8(236);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 235:
        return HeartbeatSampleDto.decode(readValue(buffer)!);
      case 236:
        return HeartbeatSeriesRecordDto.decode(readValue(buffer)!);
      case 237:
