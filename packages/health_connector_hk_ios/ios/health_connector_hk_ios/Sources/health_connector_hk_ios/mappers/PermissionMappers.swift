...
extension HealthDataPermissionDto {
     ...
     *
     * ## Correlation Types
     * Some health data types are correlation types that contain multiple sub-types:
     * - `.nutrition` → Contains the food correlation type plus all nutrient quantity types
     * - `.bloodPressure` → Contains the blood pressure correlation type plus systolic and diastolic quantity types
     *
