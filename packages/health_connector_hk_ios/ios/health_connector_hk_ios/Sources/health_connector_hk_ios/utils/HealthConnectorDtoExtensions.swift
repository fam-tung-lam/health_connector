...
extension HealthRecordDto {
    ...
    var id: String? {
        ...
        case let record as IrregularMenstrualCycleEventRecordDto:
            record.id
        case let record as PersistentIntermenstrualBleedingEventRecordDto:
            record.id
        ...
        case let record as EnvironmentalAudioExposureRecordDto:
            record.id
        case let record as HeadphoneAudioExposureRecordDto:
            record.id
        default:
            nil
        }
    ...
    var dataType: HealthDataTypeDto {
        get throws {
            ...
            case is PersistentIntermenstrualBleedingEventRecordDto:
    ...
    func extractTimestamp() throws -> Int64 {
        ...
        case let dto as WalkingSteadinessRecordDto:
            return dto.endTime
        case let dto as WalkingSteadinessEventRecordDto:
            return dto.endTime
