...
private func doubleEqualsHealthConnectorHKIOSApi(_ lhs: Double, _ rhs: Double) -> Bool {
  return (lhs.isNaN && rhs.isNaN) || lhs == rhs
}

private func doubleHashHealthConnectorHKIOSApi(_ value: Double, _ hasher: inout Hasher) {
  if value.isNaN {
...
func deepEqualsHealthConnectorHKIOSApi(_ lhs: Any?, _ rhs: Any?) -> Bool {
  ...
  case (let lhsArray, let rhsArray) as ([Any?], [Any?]):
    ...
    for (index, element) in lhsArray.enumerated() {
      if !deepEqualsHealthConnectorHKIOSApi(element, rhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case (let lhsArray, let rhsArray) as ([Double], [Double]):
    guard lhsArray.count == rhsArray.count else { return false }
    for (index, element) in lhsArray.enumerated() {
      if !doubleEqualsHealthConnectorHKIOSApi(element, rhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case (let lhsDictionary, let rhsDictionary) as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    for (lhsKey, lhsValue) in lhsDictionary {
      ...
      for (rhsKey, rhsValue) in rhsDictionary {
        if deepEqualsHealthConnectorHKIOSApi(lhsKey, rhsKey) {
          if deepEqualsHealthConnectorHKIOSApi(lhsValue, rhsValue) {
            found = true
            break
          } else {
            return false
  ...
  case (let lhs as Double, let rhs as Double):
    return doubleEqualsHealthConnectorHKIOSApi(lhs, rhs)
...
func deepHashHealthConnectorHKIOSApi(value: Any?, hasher: inout Hasher) {
  ...
  if let cleanValue = cleanValue {
    if let doubleValue = cleanValue as? Double {
      doubleHashHealthConnectorHKIOSApi(doubleValue, &hasher)
    } else if let valueList = cleanValue as? [Any?] {
      for item in valueList {
        deepHashHealthConnectorHKIOSApi(value: item, hasher: &hasher)
      }
    } else if let valueList = cleanValue as? [Double] {
      for item in valueList {
        doubleHashHealthConnectorHKIOSApi(item, &hasher)
      }
    } else if let valueDict = cleanValue as? [AnyHashable: Any?] {
      var result = 0
      for (key, value) in valueDict {
        var entryKeyHasher = Hasher()
        deepHashHealthConnectorHKIOSApi(value: key, hasher: &entryKeyHasher)
        var entryValueHasher = Hasher()
        deepHashHealthConnectorHKIOSApi(value: value, hasher: &entryValueHasher)
...
public enum InsulinDeliveryReasonDto: Int {
...
public enum HealthDataTypeDto: Int {
  ...
  case forcedExpiratoryVolume = 6
  /// Peak Expiratory Flow Rate data.
  case peakExpiratoryFlowRate = 7
  /// Walking Heart Rate Average data.
  case walkingHeartRateAverage = 8
  /// Walking Double Support Percentage data type.
  case walkingDoubleSupportPercentage = 9
...
public enum ExerciseSessionStateTransitionTypeDto: Int {
...
public enum ExerciseSegmentTypeDto: Int {
  ...
  case benchSitUp = 6
  case biking = 7
  case bikingStationary = 8
  case burpee = 9
  case crunch = 10
  case deadlift = 11
  case doubleArmTricepsExtension = 12
  case dumbbellCurlLeftArm = 13
  case dumbbellCurlRightArm = 14
  case dumbbellFrontRaise = 15
  case dumbbellLateralRaise = 16
  case dumbbellRow = 17
  case dumbbellTricepsExtensionLeftArm = 18
  case dumbbellTricepsExtensionRightArm = 19
  case dumbbellTricepsExtensionTwoArm = 20
  case elliptical = 21
  case forwardTwist = 22
  case frontRaise = 23
  case highIntensityIntervalTraining = 24
  case hipThrust = 25
  case hulaHoop = 26
  case jumpingJack = 27
  case jumpRope = 28
  case kettlebellSwing = 29
  case lateralRaise = 30
  case latPullDown = 31
  case legCurl = 32
  case legExtension = 33
  case legPress = 34
  case legRaise = 35
  case lunge = 36
  case mountainClimber = 37
  case otherWorkout = 38
  case pause = 39
  case pilates = 40
  case plank = 41
  case pullUp = 42
  case punch = 43
  case rest = 44
  case rowingMachine = 45
  case running = 46
  case runningTreadmill = 47
  case shoulderPress = 48
  case singleArmTricepsExtension = 49
  case sitUp = 50
  case squat = 51
  case stairClimbing = 52
  case stairClimbingMachine = 53
  case stretching = 54
  case swimmingBackstroke = 55
  case swimmingBreaststroke = 56
  case swimmingButterfly = 57
  case swimmingFreestyle = 58
  case swimmingMixed = 59
  case swimmingOpenWater = 60
  case swimmingOther = 61
  case swimmingPool = 62
  case upperTwist = 63
  case walking = 64
  case weightlifting = 65
  case wheelchair = 66
  case yoga = 67
}
...
public struct HealthConnectorConfigDto: Hashable {
  ...
  public static func == (lhs: HealthConnectorConfigDto, rhs: HealthConnectorConfigDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.isLoggerEnabled, rhs.isLoggerEnabled)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HealthConnectorConfigDto")
    deepHashHealthConnectorHKIOSApi(value: isLoggerEnabled, hasher: &hasher)
  }
}
...
public struct MetadataDto: Hashable {
  ...
  public static func == (lhs: MetadataDto, rhs: MetadataDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.clientRecordId, rhs.clientRecordId) && deepEqualsHealthConnectorHKIOSApi(lhs.clientRecordVersion, rhs.clientRecordVersion) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceType, rhs.deviceType) && deepEqualsHealthConnectorHKIOSApi(lhs.recordingMethod, rhs.recordingMethod) && deepEqualsHealthConnectorHKIOSApi(lhs.dataOrigin, rhs.dataOrigin) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceName, rhs.deviceName) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceManufacturer, rhs.deviceManufacturer) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceModel, rhs.deviceModel) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceHardwareVersion, rhs.deviceHardwareVersion) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceFirmwareVersion, rhs.deviceFirmwareVersion) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceSoftwareVersion, rhs.deviceSoftwareVersion) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceLocalIdentifier, rhs.deviceLocalIdentifier) && deepEqualsHealthConnectorHKIOSApi(lhs.deviceUdiDeviceIdentifier, rhs.deviceUdiDeviceIdentifier)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("MetadataDto")
    deepHashHealthConnectorHKIOSApi(value: clientRecordId, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: clientRecordVersion, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: recordingMethod, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: dataOrigin, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceName, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceManufacturer, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceModel, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceHardwareVersion, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceFirmwareVersion, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceSoftwareVersion, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceLocalIdentifier, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deviceUdiDeviceIdentifier, hasher: &hasher)
  }
}
...
public struct RestingHeartRateRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: RestingHeartRateRecordDto, rhs: RestingHeartRateRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.beatsPerMinute, rhs.beatsPerMinute) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("RestingHeartRateRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: beatsPerMinute, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct WalkingHeartRateAverageRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  ...
  public static func == (lhs: WalkingHeartRateAverageRecordDto, rhs: WalkingHeartRateAverageRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.beatsPerMinute, rhs.beatsPerMinute) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("WalkingHeartRateAverageRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: beatsPerMinute, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct LowCardioFitnessEventRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  var vo2MlPerMinPerKg: Double? = nil
  /// The VO2 max threshold in mL/kg/min.
  var vo2MlPerMinPerKgThreshold: Double? = nil
  /// Timezone offset in seconds for start time.
  var startZoneOffsetSeconds: Int64? = nil
  /// Timezone offset in seconds for end time.
  var endZoneOffsetSeconds: Int64? = nil
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> LowCardioFitnessEventRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    let vo2MlPerMinPerKg: Double? = nilOrValue(pigeonVar_list[4])
    let vo2MlPerMinPerKgThreshold: Double? = nilOrValue(pigeonVar_list[5])
    let startZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[6])
    let endZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[7])

    return LowCardioFitnessEventRecordDto(
      id: id,
      startTime: startTime,
      endTime: endTime,
      metadata: metadata,
  ...
  func toList() -> [Any?] {
    return [
      ...
      metadata,
      vo2MlPerMinPerKg,
      vo2MlPerMinPerKgThreshold,
      startZoneOffsetSeconds,
      endZoneOffsetSeconds,
    ]
  }
  public static func == (lhs: LowCardioFitnessEventRecordDto, rhs: LowCardioFitnessEventRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.vo2MlPerMinPerKg, rhs.vo2MlPerMinPerKg) && deepEqualsHealthConnectorHKIOSApi(lhs.vo2MlPerMinPerKgThreshold, rhs.vo2MlPerMinPerKgThreshold) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("LowCardioFitnessEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vo2MlPerMinPerKg, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vo2MlPerMinPerKgThreshold, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct EnvironmentalAudioExposureEventRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  var aWeightedDecibel: Double? = nil


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> EnvironmentalAudioExposureEventRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    ...
    let aWeightedDecibel: Double? = nilOrValue(pigeonVar_list[6])

    return EnvironmentalAudioExposureEventRecordDto(
      id: id,
      startTime: startTime,
      endTime: endTime,
      metadata: metadata,
  ...
  public static func == (lhs: EnvironmentalAudioExposureEventRecordDto, rhs: EnvironmentalAudioExposureEventRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.aWeightedDecibel, rhs.aWeightedDecibel)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("EnvironmentalAudioExposureEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: aWeightedDecibel, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct HeadphoneAudioExposureEventRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> HeadphoneAudioExposureEventRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    ...
    return HeadphoneAudioExposureEventRecordDto(
      id: id,
      startTime: startTime,
      endTime: endTime,
      metadata: metadata,
  ...
  public static func == (lhs: HeadphoneAudioExposureEventRecordDto, rhs: HeadphoneAudioExposureEventRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("HeadphoneAudioExposureEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct EnvironmentalAudioExposureRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> EnvironmentalAudioExposureRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    let aWeightedDecibel = pigeonVar_list[4] as! Double
    let startZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[5])
    let endZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[6])
  ...
  public static func == (lhs: EnvironmentalAudioExposureRecordDto, rhs: EnvironmentalAudioExposureRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.aWeightedDecibel, rhs.aWeightedDecibel) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("EnvironmentalAudioExposureRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct HeadphoneAudioExposureRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> HeadphoneAudioExposureRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
  ...
  public static func == (lhs: HeadphoneAudioExposureRecordDto, rhs: HeadphoneAudioExposureRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.aWeightedDecibel, rhs.aWeightedDecibel) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("HeadphoneAudioExposureRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct LowHeartRateEventRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: LowHeartRateEventRecordDto, rhs: LowHeartRateEventRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.beatsPerMinuteThreshold, rhs.beatsPerMinuteThreshold) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("LowHeartRateEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: beatsPerMinuteThreshold, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct HighHeartRateEventRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("HighHeartRateEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct IrregularMenstrualCycleEventRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> IrregularMenstrualCycleEventRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    ...
    return IrregularMenstrualCycleEventRecordDto(
      id: id,
      startTime: startTime,
      endTime: endTime,
      metadata: metadata,
  ...
  public static func == (lhs: IrregularMenstrualCycleEventRecordDto, rhs: IrregularMenstrualCycleEventRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("IrregularMenstrualCycleEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct InfrequentMenstrualCycleEventRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("InfrequentMenstrualCycleEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct IrregularHeartRhythmEventRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("IrregularHeartRhythmEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct WalkingSteadinessEventRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: WalkingSteadinessEventRecordDto, rhs: WalkingSteadinessEventRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.type, rhs.type) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("WalkingSteadinessEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: type, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct Vo2MaxRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: Vo2MaxRecordDto, rhs: Vo2MaxRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.millilitersPerKilogramPerMinute, rhs.millilitersPerKilogramPerMinute) && deepEqualsHealthConnectorHKIOSApi(lhs.testType, rhs.testType) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("Vo2MaxRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: millilitersPerKilogramPerMinute, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: testType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct ForcedVitalCapacityRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: ForcedVitalCapacityRecordDto, rhs: ForcedVitalCapacityRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.liters, rhs.liters) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ForcedVitalCapacityRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: liters, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct ForcedExpiratoryVolumeRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Metadata about this record.
  var metadata: MetadataDto
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> ForcedExpiratoryVolumeRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
  ...
  public static func == (lhs: ForcedExpiratoryVolumeRecordDto, rhs: ForcedExpiratoryVolumeRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.liters, rhs.liters) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ForcedExpiratoryVolumeRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct PeakExpiratoryFlowRateRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Metadata about this record.
  var metadata: MetadataDto
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PeakExpiratoryFlowRateRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let metadata = pigeonVar_list[1] as! MetadataDto
    let startTime = pigeonVar_list[2] as! Int64
    let endTime = pigeonVar_list[3] as! Int64
    let litersPerSecond = pigeonVar_list[4] as! Double
    let startZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[5])
    let endZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[6])
  ...
  public static func == (lhs: PeakExpiratoryFlowRateRecordDto, rhs: PeakExpiratoryFlowRateRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.litersPerSecond, rhs.litersPerSecond) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("PeakExpiratoryFlowRateRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: litersPerSecond, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct BodyMassIndexRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: BodyMassIndexRecordDto, rhs: BodyMassIndexRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.bodyMassIndex, rhs.bodyMassIndex) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("BodyMassIndexRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: bodyMassIndex, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct WaistCircumferenceRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: WaistCircumferenceRecordDto, rhs: WaistCircumferenceRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.meters, rhs.meters) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("WaistCircumferenceRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: meters, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct HeartRateVariabilitySDNNRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: HeartRateVariabilitySDNNRecordDto, rhs: HeartRateVariabilitySDNNRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.heartRateVariabilityMillis, rhs.heartRateVariabilityMillis) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HeartRateVariabilitySDNNRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: heartRateVariabilityMillis, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct BloodGlucoseRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: BloodGlucoseRecordDto, rhs: BloodGlucoseRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.millimolesPerLiter, rhs.millimolesPerLiter) && deepEqualsHealthConnectorHKIOSApi(lhs.mealType, rhs.mealType) && deepEqualsHealthConnectorHKIOSApi(lhs.relationToMeal, rhs.relationToMeal) && deepEqualsHealthConnectorHKIOSApi(lhs.specimenSource, rhs.specimenSource) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("BloodGlucoseRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: millimolesPerLiter, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: mealType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: relationToMeal, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: specimenSource, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
/// Generated class from Pigeon that represents data sent in messages.
/// This protocol should not be extended by any user class outside of the generated file.
protocol ExerciseSessionEventDto {
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct ExerciseSessionStateTransitionEventDto: ExerciseSessionEventDto {
  /// Time in milliseconds since epoch (UTC).
  var time: Int64
  /// The type of state transition.
  var type: ExerciseSessionStateTransitionTypeDto


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> ExerciseSessionStateTransitionEventDto? {
    let time = pigeonVar_list[0] as! Int64
    let type = pigeonVar_list[1] as! ExerciseSessionStateTransitionTypeDto
  ...
  public static func == (lhs: ExerciseSessionStateTransitionEventDto, rhs: ExerciseSessionStateTransitionEventDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.type, rhs.type)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseSessionStateTransitionEventDto")
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: type, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct ExerciseSessionMarkerEventDto: ExerciseSessionEventDto {
  /// Time in milliseconds since epoch (UTC).
  var time: Int64


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> ExerciseSessionMarkerEventDto? {
    let time = pigeonVar_list[0] as! Int64
  ...
  public static func == (lhs: ExerciseSessionMarkerEventDto, rhs: ExerciseSessionMarkerEventDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseSessionMarkerEventDto")
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct ExerciseSessionLapEventDto: ExerciseSessionEventDto {
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  /// End time in milliseconds since epoch (UTC).
  var endTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> ExerciseSessionLapEventDto? {
    let startTime = pigeonVar_list[0] as! Int64
    let endTime = pigeonVar_list[1] as! Int64
    let distanceMeters: Double? = nilOrValue(pigeonVar_list[2])
  ...
  public static func == (lhs: ExerciseSessionLapEventDto, rhs: ExerciseSessionLapEventDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.distanceMeters, rhs.distanceMeters)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseSessionLapEventDto")
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: distanceMeters, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct ExerciseSessionSegmentEventDto: ExerciseSessionEventDto {
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  /// End time in milliseconds since epoch (UTC).
  var endTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> ExerciseSessionSegmentEventDto? {
    let startTime = pigeonVar_list[0] as! Int64
    let endTime = pigeonVar_list[1] as! Int64
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseSessionSegmentEventDto")
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
...
public struct ExerciseRouteLocationDto: Hashable {
  ...
  public static func == (lhs: ExerciseRouteLocationDto, rhs: ExerciseRouteLocationDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.latitude, rhs.latitude) && deepEqualsHealthConnectorHKIOSApi(lhs.longitude, rhs.longitude) && deepEqualsHealthConnectorHKIOSApi(lhs.altitudeMeters, rhs.altitudeMeters) && deepEqualsHealthConnectorHKIOSApi(lhs.horizontalAccuracyMeters, rhs.horizontalAccuracyMeters) && deepEqualsHealthConnectorHKIOSApi(lhs.verticalAccuracyMeters, rhs.verticalAccuracyMeters)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseRouteLocationDto")
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: latitude, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: longitude, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: altitudeMeters, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: horizontalAccuracyMeters, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: verticalAccuracyMeters, hasher: &hasher)
  }
}
...
public struct ExerciseRouteDto: Hashable {
  ...
  public static func == (lhs: ExerciseRouteDto, rhs: ExerciseRouteDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.locations, rhs.locations)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseRouteDto")
    deepHashHealthConnectorHKIOSApi(value: locations, hasher: &hasher)
  }
}
...
public struct ExerciseSessionRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: ExerciseSessionRecordDto, rhs: ExerciseSessionRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.exerciseType, rhs.exerciseType) && deepEqualsHealthConnectorHKIOSApi(lhs.title, rhs.title) && deepEqualsHealthConnectorHKIOSApi(lhs.notes, rhs.notes) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.events, rhs.events) && deepEqualsHealthConnectorHKIOSApi(lhs.exerciseRoute, rhs.exerciseRoute)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseSessionRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: exerciseType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: title, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: notes, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: events, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: exerciseRoute, hasher: &hasher)
  }
}
...
public struct MindfulnessSessionRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: MindfulnessSessionRecordDto, rhs: MindfulnessSessionRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.sessionType, rhs.sessionType) && deepEqualsHealthConnectorHKIOSApi(lhs.title, rhs.title) && deepEqualsHealthConnectorHKIOSApi(lhs.notes, rhs.notes) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("MindfulnessSessionRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: sessionType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: title, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: notes, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
...
public struct ActiveEnergyBurnedRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: ActiveEnergyBurnedRecordDto, rhs: ActiveEnergyBurnedRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.kilocalories, rhs.kilocalories) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ActiveEnergyBurnedRecordDto")
    deepHashHealthConnectorHKIOSApi(value: kilocalories, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
...
public struct AlcoholicBeveragesRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: AlcoholicBeveragesRecordDto, rhs: AlcoholicBeveragesRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.count, rhs.count) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("AlcoholicBeveragesRecordDto")
    deepHashHealthConnectorHKIOSApi(value: count, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
...
public struct ExerciseTimeRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: ExerciseTimeRecordDto, rhs: ExerciseTimeRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.seconds, rhs.seconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseTimeRecordDto")
    deepHashHealthConnectorHKIOSApi(value: seconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
...
public struct MoveTimeRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("MoveTimeRecordDto")
    deepHashHealthConnectorHKIOSApi(value: seconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct StandTimeRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("StandTimeRecordDto")
    deepHashHealthConnectorHKIOSApi(value: seconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct WalkingSteadinessRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: WalkingSteadinessRecordDto, rhs: WalkingSteadinessRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.percentage, rhs.percentage) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("WalkingSteadinessRecordDto")
    deepHashHealthConnectorHKIOSApi(value: percentage, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
...
public struct WalkingAsymmetryPercentageRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: WalkingAsymmetryPercentageRecordDto, rhs: WalkingAsymmetryPercentageRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.percentage, rhs.percentage) && deepEqualsHealthConnectorHKIOSApi(lhs.devicePlacementSide, rhs.devicePlacementSide) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("WalkingAsymmetryPercentageRecordDto")
    deepHashHealthConnectorHKIOSApi(value: percentage, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: devicePlacementSide, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
...
public struct WalkingDoubleSupportPercentageRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("WalkingDoubleSupportPercentageRecordDto")
    deepHashHealthConnectorHKIOSApi(value: percentage, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: devicePlacementSide, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
...
public struct WalkingStepLengthRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: WalkingStepLengthRecordDto, rhs: WalkingStepLengthRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.meters, rhs.meters) && deepEqualsHealthConnectorHKIOSApi(lhs.devicePlacementSide, rhs.devicePlacementSide) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("WalkingStepLengthRecordDto")
    deepHashHealthConnectorHKIOSApi(value: meters, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: devicePlacementSide, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct RunningGroundContactTimeRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> RunningGroundContactTimeRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
  ...
  public static func == (lhs: RunningGroundContactTimeRecordDto, rhs: RunningGroundContactTimeRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.seconds, rhs.seconds) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("RunningGroundContactTimeRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: seconds, hasher: &hasher)
...
/// Generated class from Pigeon that represents data sent in messages.
public struct RunningStrideLengthRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> RunningStrideLengthRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let strideLength = pigeonVar_list[3] as! Double
    let metadata = pigeonVar_list[4] as! MetadataDto
    let startZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[5])
    let endZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[6])
  ...
  public static func == (lhs: RunningStrideLengthRecordDto, rhs: RunningStrideLengthRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.strideLength, rhs.strideLength) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("RunningStrideLengthRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: strideLength, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
...
public struct DistanceActivityRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: DistanceActivityRecordDto, rhs: DistanceActivityRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.meters, rhs.meters) && deepEqualsHealthConnectorHKIOSApi(lhs.activityType, rhs.activityType) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("DistanceActivityRecordDto")
    deepHashHealthConnectorHKIOSApi(value: meters, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: activityType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
...
public struct SpeedActivityRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: SpeedActivityRecordDto, rhs: SpeedActivityRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.metersPerSecond, rhs.metersPerSecond) && deepEqualsHealthConnectorHKIOSApi(lhs.activityType, rhs.activityType) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("SpeedActivityRecordDto")
    deepHashHealthConnectorHKIOSApi(value: metersPerSecond, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: activityType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct FloorsClimbedRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: FloorsClimbedRecordDto, rhs: FloorsClimbedRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.floors, rhs.floors) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("FloorsClimbedRecordDto")
    deepHashHealthConnectorHKIOSApi(value: floors, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
...
public struct WheelchairPushesRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: WheelchairPushesRecordDto, rhs: WheelchairPushesRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.pushes, rhs.pushes) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("WheelchairPushesRecordDto")
    deepHashHealthConnectorHKIOSApi(value: pushes, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
...
public struct SwimmingStrokesRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("SwimmingStrokesRecordDto")
    deepHashHealthConnectorHKIOSApi(value: count, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct WeightRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: WeightRecordDto, rhs: WeightRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.kilograms, rhs.kilograms) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("WeightRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: kilograms, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct BloodPressureRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: BloodPressureRecordDto, rhs: BloodPressureRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.systolicInMillimetersOfMercury, rhs.systolicInMillimetersOfMercury) && deepEqualsHealthConnectorHKIOSApi(lhs.diastolicInMillimetersOfMercury, rhs.diastolicInMillimetersOfMercury) && deepEqualsHealthConnectorHKIOSApi(lhs.bodyPosition, rhs.bodyPosition) && deepEqualsHealthConnectorHKIOSApi(lhs.measurementLocation, rhs.measurementLocation) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("BloodPressureRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: systolicInMillimetersOfMercury, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: diastolicInMillimetersOfMercury, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: bodyPosition, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: measurementLocation, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct SystolicBloodPressureRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: SystolicBloodPressureRecordDto, rhs: SystolicBloodPressureRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.millimetersOfMercury, rhs.millimetersOfMercury) && deepEqualsHealthConnectorHKIOSApi(lhs.bodyPosition, rhs.bodyPosition) && deepEqualsHealthConnectorHKIOSApi(lhs.measurementLocation, rhs.measurementLocation) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("SystolicBloodPressureRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: millimetersOfMercury, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: bodyPosition, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: measurementLocation, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
...
public struct DiastolicBloodPressureRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DiastolicBloodPressureRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: millimetersOfMercury, hasher: &hasher)
...
public struct LeanBodyMassRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("LeanBodyMassRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: kilograms, hasher: &hasher)
...
public struct HeightRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: HeightRecordDto, rhs: HeightRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.meters, rhs.meters) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HeightRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: meters, hasher: &hasher)
...
public struct BloodAlcoholContentRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: BloodAlcoholContentRecordDto, rhs: BloodAlcoholContentRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.percentage, rhs.percentage)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("BloodAlcoholContentRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct BodyFatPercentageRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: BodyFatPercentageRecordDto, rhs: BodyFatPercentageRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.percentage, rhs.percentage) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("BodyFatPercentageRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: percentage, hasher: &hasher)
...
public struct BodyTemperatureRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: BodyTemperatureRecordDto, rhs: BodyTemperatureRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.celsius, rhs.celsius) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("BodyTemperatureRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: celsius, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct BasalBodyTemperatureRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: BasalBodyTemperatureRecordDto, rhs: BasalBodyTemperatureRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.celsius, rhs.celsius) && deepEqualsHealthConnectorHKIOSApi(lhs.measurementLocation, rhs.measurementLocation) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("BasalBodyTemperatureRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: celsius, hasher: &hasher)
...
public struct SleepingWristTemperatureRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: SleepingWristTemperatureRecordDto, rhs: SleepingWristTemperatureRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.temperatureCelsius, rhs.temperatureCelsius) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("SleepingWristTemperatureRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: temperatureCelsius, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct CervicalMucusRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: CervicalMucusRecordDto, rhs: CervicalMucusRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.appearance, rhs.appearance) && deepEqualsHealthConnectorHKIOSApi(lhs.sensation, rhs.sensation)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("CervicalMucusRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: appearance, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: sensation, hasher: &hasher)
  }
}
...
public struct CyclingPowerRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: CyclingPowerRecordDto, rhs: CyclingPowerRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.watts, rhs.watts) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("CyclingPowerRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: watts, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct RunningPowerRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("RunningPowerRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: watts, hasher: &hasher)
...
public struct OxygenSaturationRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: OxygenSaturationRecordDto, rhs: OxygenSaturationRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.percentage, rhs.percentage) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("OxygenSaturationRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: percentage, hasher: &hasher)
...
public struct OvulationTestRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: OvulationTestRecordDto, rhs: OvulationTestRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.result, rhs.result)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("OvulationTestRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: result, hasher: &hasher)
  }
}
...
public struct PregnancyTestRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("PregnancyTestRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct PregnancyRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("PregnancyRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
...
public struct ContraceptiveRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: ContraceptiveRecordDto, rhs: ContraceptiveRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.contraceptiveType, rhs.contraceptiveType) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ContraceptiveRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: contraceptiveType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct ProgesteroneTestRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("ProgesteroneTestRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct IntermenstrualBleedingRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: IntermenstrualBleedingRecordDto, rhs: IntermenstrualBleedingRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("IntermenstrualBleedingRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct MenstrualFlowRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: MenstrualFlowRecordDto, rhs: MenstrualFlowRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.flow, rhs.flow) && deepEqualsHealthConnectorHKIOSApi(lhs.isCycleStart, rhs.isCycleStart)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("MenstrualFlowRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: flow, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: isCycleStart, hasher: &hasher)
  }
}
...
public struct RespiratoryRateRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: RespiratoryRateRecordDto, rhs: RespiratoryRateRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.breathsPerMinute, rhs.breathsPerMinute) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("RespiratoryRateRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: breathsPerMinute, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct ElectrodermalActivityRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> ElectrodermalActivityRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    let conductance = pigeonVar_list[4] as! Double
    let startZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[5])
    let endZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[6])
  ...
  public static func == (lhs: ElectrodermalActivityRecordDto, rhs: ElectrodermalActivityRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.conductance, rhs.conductance) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ElectrodermalActivityRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: conductance, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct HydrationRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: HydrationRecordDto, rhs: HydrationRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.liters, rhs.liters) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HydrationRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct InsulinDeliveryRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  var reason: InsulinDeliveryReasonDto
  /// Timezone offset in seconds for start time.
  var startZoneOffsetSeconds: Int64? = nil
  /// Timezone offset in seconds for end time.
  var endZoneOffsetSeconds: Int64? = nil
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> InsulinDeliveryRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    let units = pigeonVar_list[4] as! Double
    let reason = pigeonVar_list[5] as! InsulinDeliveryReasonDto
    let startZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[6])
    let endZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[7])
  ...
  public static func == (lhs: InsulinDeliveryRecordDto, rhs: InsulinDeliveryRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.units, rhs.units) && deepEqualsHealthConnectorHKIOSApi(lhs.reason, rhs.reason) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("InsulinDeliveryRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: units, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: reason, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct InhalerUsageRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> InhalerUsageRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    let puffs = pigeonVar_list[4] as! Double
    let startZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[5])
    let endZoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[6])
  ...
  public static func == (lhs: InhalerUsageRecordDto, rhs: InhalerUsageRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.puffs, rhs.puffs) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("InhalerUsageRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: puffs, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct HeartRateMeasurementDto: Hashable {
  ...
  public static func == (lhs: HeartRateMeasurementDto, rhs: HeartRateMeasurementDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.beatsPerMinute, rhs.beatsPerMinute)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HeartRateMeasurementDto")
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: beatsPerMinute, hasher: &hasher)
  }
}
...
public struct HeartRateRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("HeartRateRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: beatsPerMinute, hasher: &hasher)
...
public struct CyclingPedalingCadenceRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: CyclingPedalingCadenceRecordDto, rhs: CyclingPedalingCadenceRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.revolutionsPerMinute, rhs.revolutionsPerMinute) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("CyclingPedalingCadenceRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: revolutionsPerMinute, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
  }
...
public struct HeartRateRecoveryOneMinuteRecordDto: HealthRecordDto {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> HeartRateRecoveryOneMinuteRecordDto? {
    ...
    let beatsPerMinute = pigeonVar_list[6] as! Double
  ...
  public static func == (lhs: HeartRateRecoveryOneMinuteRecordDto, rhs: HeartRateRecoveryOneMinuteRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.beatsPerMinute, rhs.beatsPerMinute)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HeartRateRecoveryOneMinuteRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
...
public struct SleepStageRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: SleepStageRecordDto, rhs: SleepStageRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.stageType, rhs.stageType) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("SleepStageRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: stageType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startZoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endZoneOffsetSeconds, hasher: &hasher)
  }
}
...
public struct SexualActivityRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: SexualActivityRecordDto, rhs: SexualActivityRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.protectionUsed, rhs.protectionUsed)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("SexualActivityRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: protectionUsed, hasher: &hasher)
  }
}
...
public struct DietaryEnergyConsumedRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: DietaryEnergyConsumedRecordDto, rhs: DietaryEnergyConsumedRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.kilocalories, rhs.kilocalories) && deepEqualsHealthConnectorHKIOSApi(lhs.foodName, rhs.foodName) && deepEqualsHealthConnectorHKIOSApi(lhs.mealType, rhs.mealType)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryEnergyConsumedRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: kilocalories, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: foodName, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: mealType, hasher: &hasher)
  }
}
...
public struct DietaryCaffeineRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: DietaryCaffeineRecordDto, rhs: DietaryCaffeineRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.grams, rhs.grams) && deepEqualsHealthConnectorHKIOSApi(lhs.foodName, rhs.foodName) && deepEqualsHealthConnectorHKIOSApi(lhs.mealType, rhs.mealType)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryCaffeineRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: grams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: foodName, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: mealType, hasher: &hasher)
  }
}
...
public struct DietaryProteinRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryProteinRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryTotalCarbohydrateRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryTotalCarbohydrateRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryTotalFatRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryTotalFatRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietarySaturatedFatRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietarySaturatedFatRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryMonounsaturatedFatRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryMonounsaturatedFatRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryPolyunsaturatedFatRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryPolyunsaturatedFatRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryCholesterolRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryCholesterolRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryFiberRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryFiberRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietarySugarRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietarySugarRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryVitaminARecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryVitaminARecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryVitaminB6RecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryVitaminB6RecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryVitaminB12RecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryVitaminB12RecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryVitaminCRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryVitaminCRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryVitaminDRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryVitaminDRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryVitaminERecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryVitaminERecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct LactationRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("LactationRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
...
public struct DietaryVitaminKRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryVitaminKRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryThiaminRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryThiaminRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryRiboflavinRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryRiboflavinRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryNiacinRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryNiacinRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryFolateRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryFolateRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryBiotinRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryBiotinRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryPantothenicAcidRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryPantothenicAcidRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryCalciumRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryCalciumRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryIronRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryIronRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryMagnesiumRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryMagnesiumRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryManganeseRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryManganeseRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryPhosphorusRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryPhosphorusRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryPotassiumRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryPotassiumRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietarySeleniumRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietarySeleniumRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietarySodiumRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietarySodiumRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct DietaryZincRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("DietaryZincRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
...
public struct NutritionRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: NutritionRecordDto, rhs: NutritionRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.foodName, rhs.foodName) && deepEqualsHealthConnectorHKIOSApi(lhs.mealType, rhs.mealType) && deepEqualsHealthConnectorHKIOSApi(lhs.energyKilocalories, rhs.energyKilocalories) && deepEqualsHealthConnectorHKIOSApi(lhs.proteinInGrams, rhs.proteinInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.totalCarbohydrateInGrams, rhs.totalCarbohydrateInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.totalFatInGrams, rhs.totalFatInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.saturatedFatInGrams, rhs.saturatedFatInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.monounsaturatedFatInGrams, rhs.monounsaturatedFatInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.polyunsaturatedFatInGrams, rhs.polyunsaturatedFatInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.cholesterolInGrams, rhs.cholesterolInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.dietaryFiberInGrams, rhs.dietaryFiberInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.sugarInGrams, rhs.sugarInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.vitaminAInGrams, rhs.vitaminAInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.vitaminB6InGrams, rhs.vitaminB6InGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.vitaminB12InGrams, rhs.vitaminB12InGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.vitaminCInGrams, rhs.vitaminCInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.vitaminDInGrams, rhs.vitaminDInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.vitaminEInGrams, rhs.vitaminEInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.vitaminKInGrams, rhs.vitaminKInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.thiaminInGrams, rhs.thiaminInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.riboflavinInGrams, rhs.riboflavinInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.niacinInGrams, rhs.niacinInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.folateInGrams, rhs.folateInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.biotinInGrams, rhs.biotinInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.pantothenicAcidInGrams, rhs.pantothenicAcidInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.calciumInGrams, rhs.calciumInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.ironInGrams, rhs.ironInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.magnesiumInGrams, rhs.magnesiumInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.manganeseInGrams, rhs.manganeseInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.phosphorusInGrams, rhs.phosphorusInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.potassiumInGrams, rhs.potassiumInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.seleniumInGrams, rhs.seleniumInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.sodiumInGrams, rhs.sodiumInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.zincInGrams, rhs.zincInGrams) && deepEqualsHealthConnectorHKIOSApi(lhs.caffeineInGrams, rhs.caffeineInGrams)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("NutritionRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    ...
    deepHashHealthConnectorHKIOSApi(value: foodName, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: mealType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: energyKilocalories, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: proteinInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: totalCarbohydrateInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: totalFatInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: saturatedFatInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: monounsaturatedFatInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: polyunsaturatedFatInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: cholesterolInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: dietaryFiberInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: sugarInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vitaminAInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vitaminB6InGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vitaminB12InGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vitaminCInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vitaminDInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vitaminEInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: vitaminKInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: thiaminInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: riboflavinInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: niacinInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: folateInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: biotinInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: pantothenicAcidInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: calciumInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: ironInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: magnesiumInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: manganeseInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: phosphorusInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: potassiumInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: seleniumInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: sodiumInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zincInGrams, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: caffeineInGrams, hasher: &hasher)
  }
}
...
public struct BasalEnergyBurnedRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: BasalEnergyBurnedRecordDto, rhs: BasalEnergyBurnedRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.kilocalories, rhs.kilocalories)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("BasalEnergyBurnedRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
...
public struct HealthDataSyncTokenDto: Hashable {
  ...
  public static func == (lhs: HealthDataSyncTokenDto, rhs: HealthDataSyncTokenDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.token, rhs.token) && deepEqualsHealthConnectorHKIOSApi(lhs.dataTypes, rhs.dataTypes) && deepEqualsHealthConnectorHKIOSApi(lhs.createdAtMillis, rhs.createdAtMillis)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HealthDataSyncTokenDto")
    deepHashHealthConnectorHKIOSApi(value: token, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: dataTypes, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: createdAtMillis, hasher: &hasher)
  }
}
...
public struct HealthDataSyncResultDto: Hashable {
  ...
  public static func == (lhs: HealthDataSyncResultDto, rhs: HealthDataSyncResultDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.upsertedRecords, rhs.upsertedRecords) && deepEqualsHealthConnectorHKIOSApi(lhs.deletedRecordIds, rhs.deletedRecordIds) && deepEqualsHealthConnectorHKIOSApi(lhs.hasMore, rhs.hasMore) && deepEqualsHealthConnectorHKIOSApi(lhs.nextSyncToken, rhs.nextSyncToken)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HealthDataSyncResultDto")
    deepHashHealthConnectorHKIOSApi(value: upsertedRecords, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: deletedRecordIds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: hasMore, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: nextSyncToken, hasher: &hasher)
  }
}
...
public struct HealthDataPermissionRequestDto: PermissionRequestDto {
  ...
  public static func == (lhs: HealthDataPermissionRequestDto, rhs: HealthDataPermissionRequestDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.accessType, rhs.accessType) && deepEqualsHealthConnectorHKIOSApi(lhs.healthDataType, rhs.healthDataType)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HealthDataPermissionRequestDto")
    deepHashHealthConnectorHKIOSApi(value: accessType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: healthDataType, hasher: &hasher)
  }
}
...
public struct ExerciseRoutePermissionRequestDto: PermissionRequestDto {
  ...
  public static func == (lhs: ExerciseRoutePermissionRequestDto, rhs: ExerciseRoutePermissionRequestDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.accessType, rhs.accessType)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseRoutePermissionRequestDto")
    deepHashHealthConnectorHKIOSApi(value: accessType, hasher: &hasher)
  }
}
...
public struct PermissionsRequestDto: Hashable {
  ...
  public static func == (lhs: PermissionsRequestDto, rhs: PermissionsRequestDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.permissionRequests, rhs.permissionRequests)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("PermissionsRequestDto")
    deepHashHealthConnectorHKIOSApi(value: permissionRequests, hasher: &hasher)
  }
}
...
public struct HealthDataPermissionRequestResultDto: PermissionRequestResultDto {
  ...
  public static func == (lhs: HealthDataPermissionRequestResultDto, rhs: HealthDataPermissionRequestResultDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.permission, rhs.permission) && deepEqualsHealthConnectorHKIOSApi(lhs.status, rhs.status)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HealthDataPermissionRequestResultDto")
    deepHashHealthConnectorHKIOSApi(value: permission, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: status, hasher: &hasher)
  }
}
...
public struct ExerciseRoutePermissionRequestResultDto: PermissionRequestResultDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("ExerciseRoutePermissionRequestResultDto")
    deepHashHealthConnectorHKIOSApi(value: permission, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: status, hasher: &hasher)
  }
}
...
public struct AggregateRequestDto: Hashable {
  ...
  public static func == (lhs: AggregateRequestDto, rhs: AggregateRequestDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.aggregationMetric, rhs.aggregationMetric) && deepEqualsHealthConnectorHKIOSApi(lhs.dataType, rhs.dataType) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("AggregateRequestDto")
    deepHashHealthConnectorHKIOSApi(value: aggregationMetric, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: dataType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
  }
}
...
public struct DeleteRecordsByIdsRequestDto: DeleteRecordsRequestDto {
  ...
  public static func == (lhs: DeleteRecordsByIdsRequestDto, rhs: DeleteRecordsByIdsRequestDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.dataType, rhs.dataType) && deepEqualsHealthConnectorHKIOSApi(lhs.recordIds, rhs.recordIds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("DeleteRecordsByIdsRequestDto")
    deepHashHealthConnectorHKIOSApi(value: dataType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: recordIds, hasher: &hasher)
  }
}
...
public struct DeleteRecordsByTimeRangeRequestDto: DeleteRecordsRequestDto {
  ...
  public static func == (lhs: DeleteRecordsByTimeRangeRequestDto, rhs: DeleteRecordsByTimeRangeRequestDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.dataType, rhs.dataType) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("DeleteRecordsByTimeRangeRequestDto")
    deepHashHealthConnectorHKIOSApi(value: dataType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
  }
...
public struct ReadRecordRequestDto: Hashable {
  ...
  public static func == (lhs: ReadRecordRequestDto, rhs: ReadRecordRequestDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.recordId, rhs.recordId) && deepEqualsHealthConnectorHKIOSApi(lhs.dataType, rhs.dataType)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ReadRecordRequestDto")
    deepHashHealthConnectorHKIOSApi(value: recordId, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: dataType, hasher: &hasher)
  }
}
...
public struct ReadRecordsRequestDto: Hashable {
  ...
  public static func == (lhs: ReadRecordsRequestDto, rhs: ReadRecordsRequestDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.dataType, rhs.dataType) && deepEqualsHealthConnectorHKIOSApi(lhs.pageSize, rhs.pageSize) && deepEqualsHealthConnectorHKIOSApi(lhs.pageToken, rhs.pageToken) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.dataOriginPackageNames, rhs.dataOriginPackageNames) && deepEqualsHealthConnectorHKIOSApi(lhs.sortOrder, rhs.sortOrder)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ReadRecordsRequestDto")
    deepHashHealthConnectorHKIOSApi(value: dataType, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: pageSize, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: pageToken, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: dataOriginPackageNames, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: sortOrder, hasher: &hasher)
  }
}
...
public struct ReadRecordsResponseDto: Hashable {
  ...
  public static func == (lhs: ReadRecordsResponseDto, rhs: ReadRecordsResponseDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.nextPageToken, rhs.nextPageToken) && deepEqualsHealthConnectorHKIOSApi(lhs.records, rhs.records)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("ReadRecordsResponseDto")
    deepHashHealthConnectorHKIOSApi(value: nextPageToken, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: records, hasher: &hasher)
  }
}
...
public struct HealthConnectorExceptionDto: Hashable {
  ...
  public static func == (lhs: HealthConnectorExceptionDto, rhs: HealthConnectorExceptionDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.code, rhs.code) && deepEqualsHealthConnectorHKIOSApi(lhs.message, rhs.message) && deepEqualsHealthConnectorHKIOSApi(lhs.cause, rhs.cause)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HealthConnectorExceptionDto")
    deepHashHealthConnectorHKIOSApi(value: code, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: message, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: cause, hasher: &hasher)
  }
}
...
public struct HealthConnectorLogDto: Hashable {
  ...
  public static func == (lhs: HealthConnectorLogDto, rhs: HealthConnectorLogDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.level, rhs.level) && deepEqualsHealthConnectorHKIOSApi(lhs.tag, rhs.tag) && deepEqualsHealthConnectorHKIOSApi(lhs.millisecondsSinceEpoch, rhs.millisecondsSinceEpoch) && deepEqualsHealthConnectorHKIOSApi(lhs.message, rhs.message) && deepEqualsHealthConnectorHKIOSApi(lhs.operation, rhs.operation) && deepEqualsHealthConnectorHKIOSApi(lhs.exception, rhs.exception) && deepEqualsHealthConnectorHKIOSApi(lhs.stackTrace, rhs.stackTrace) && deepEqualsHealthConnectorHKIOSApi(lhs.context, rhs.context)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("HealthConnectorLogDto")
    deepHashHealthConnectorHKIOSApi(value: level, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: tag, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: millisecondsSinceEpoch, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: message, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: operation, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: exception, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: stackTrace, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: context, hasher: &hasher)
  }
}
...
public struct PeripheralPerfusionIndexRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: PeripheralPerfusionIndexRecordDto, rhs: PeripheralPerfusionIndexRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.percentage, rhs.percentage) && deepEqualsHealthConnectorHKIOSApi(lhs.time, rhs.time) && deepEqualsHealthConnectorHKIOSApi(lhs.zoneOffsetSeconds, rhs.zoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("PeripheralPerfusionIndexRecordDto")
    deepHashHealthConnectorHKIOSApi(value: percentage, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: time, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: zoneOffsetSeconds, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
...
/// Generated class from Pigeon that represents data sent in messages.
public struct PersistentIntermenstrualBleedingEventRecordDto: HealthRecordDto {
  var id: String
  var startTime: Int64
  var endTime: Int64
  var metadata: MetadataDto
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PersistentIntermenstrualBleedingEventRecordDto? {
    ...
    return PersistentIntermenstrualBleedingEventRecordDto(
      id: id,
      startTime: startTime,
      endTime: endTime,
      metadata: metadata,
  ...
  public static func == (lhs: PersistentIntermenstrualBleedingEventRecordDto, rhs: PersistentIntermenstrualBleedingEventRecordDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("PersistentIntermenstrualBleedingEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct ProlongedMenstrualPeriodEventRecordDto: HealthRecordDto {
  ...
  public func hash(into hasher: inout Hasher) {
    hasher.combine("ProlongedMenstrualPeriodEventRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct AtrialFibrillationBurdenRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: AtrialFibrillationBurdenRecordDto, rhs: AtrialFibrillationBurdenRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.percentage, rhs.percentage) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("AtrialFibrillationBurdenRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
public struct NumberOfTimesFallenRecordDto: HealthRecordDto {
  ...
  public static func == (lhs: NumberOfTimesFallenRecordDto, rhs: NumberOfTimesFallenRecordDto) -> Bool {
    ...
    return deepEqualsHealthConnectorHKIOSApi(lhs.id, rhs.id) && deepEqualsHealthConnectorHKIOSApi(lhs.startTime, rhs.startTime) && deepEqualsHealthConnectorHKIOSApi(lhs.endTime, rhs.endTime) && deepEqualsHealthConnectorHKIOSApi(lhs.metadata, rhs.metadata) && deepEqualsHealthConnectorHKIOSApi(lhs.count, rhs.count) && deepEqualsHealthConnectorHKIOSApi(lhs.startZoneOffsetSeconds, rhs.startZoneOffsetSeconds) && deepEqualsHealthConnectorHKIOSApi(lhs.endZoneOffsetSeconds, rhs.endZoneOffsetSeconds)
  }

  public func hash(into hasher: inout Hasher) {
    hasher.combine("NumberOfTimesFallenRecordDto")
    deepHashHealthConnectorHKIOSApi(value: id, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: startTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: endTime, hasher: &hasher)
    deepHashHealthConnectorHKIOSApi(value: metadata, hasher: &hasher)
...
private class HealthConnectorHKIOSApiPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 137:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return InsulinDeliveryReasonDto(rawValue: enumResultAsInt)
      }
      return nil
    case 138:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 155:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return ExerciseSessionStateTransitionTypeDto(rawValue: enumResultAsInt)
      }
      return nil
    case 156:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return ExerciseSegmentTypeDto(rawValue: enumResultAsInt)
      }
      return nil
    case 157:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
...
private class HealthConnectorHKIOSApiPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? DeviceTypeDto {
      ...
      super.writeByte(136)
      super.writeValue(value.rawValue)
    } else if let value = value as? InsulinDeliveryReasonDto {
      super.writeByte(137)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(154)
      super.writeValue(value.rawValue)
    } else if let value = value as? ExerciseSessionStateTransitionTypeDto {
      super.writeByte(155)
      super.writeValue(value.rawValue)
    } else if let value = value as? ExerciseSegmentTypeDto {
      super.writeByte(156)
      super.writeValue(value.rawValue)
