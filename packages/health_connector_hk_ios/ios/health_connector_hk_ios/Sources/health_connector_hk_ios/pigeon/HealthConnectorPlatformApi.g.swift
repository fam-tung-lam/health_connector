...
public struct Vo2MaxDto: MeasurementUnitDto {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> Vo2MaxDto? {
    let unit = pigeonVar_list[0] as! Vo2MaxUnitDto
    let value = pigeonVar_list[1] as! Double
...
public struct RestingHeartRateRecordDto: HealthRecordDto {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> RestingHeartRateRecordDto? {
    ...
    let beatsPerMinute = pigeonVar_list[3] as! NumericDto
...
public struct Vo2MaxRecordDto: HealthRecordDto {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> Vo2MaxRecordDto? {
    ...
    let time = pigeonVar_list[1] as! Int64
    let metadata = pigeonVar_list[2] as! MetadataDto
    let vo2Max = pigeonVar_list[3] as! Vo2MaxDto
...
public struct RespiratoryRateRecordDto: HealthRecordDto {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> RespiratoryRateRecordDto? {
    ...
    let time = pigeonVar_list[1] as! Int64
    let metadata = pigeonVar_list[2] as! MetadataDto
    let rate = pigeonVar_list[3] as! NumericDto
    let zoneOffsetSeconds: Int64? = nilOrValue(pigeonVar_list[4])
...
///
/// Generated class from Pigeon that represents data sent in messages.
public struct MenstrualCycleRecordDto: HealthRecordDto {
  /// Platform-assigned unique identifier.
  var id: String? = nil
  /// Start time in milliseconds since epoch (UTC).
  var startTime: Int64
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> MenstrualCycleRecordDto? {
    let id: String? = nilOrValue(pigeonVar_list[0])
    let startTime = pigeonVar_list[1] as! Int64
    let endTime = pigeonVar_list[2] as! Int64
    let metadata = pigeonVar_list[3] as! MetadataDto
    let flow = pigeonVar_list[4] as! MenstrualFlowDto
    let isStartOfCycle = pigeonVar_list[5] as! Bool
  ...
  public static func == (lhs: MenstrualCycleRecordDto, rhs: MenstrualCycleRecordDto) -> Bool {
    return deepEqualsHealthConnectorPlatformApi(lhs.toList(), rhs.toList())  }
  public func hash(into hasher: inout Hasher) {
    deepHashHealthConnectorPlatformApi(value: toList(), hasher: &hasher)
  }
...
private class HealthConnectorPlatformApiPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 144:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return Vo2MaxUnitDto(rawValue: enumResultAsInt)
      }
      return nil
    case 145:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 164:
      return Vo2MaxDto.fromList(self.readValue() as! [Any?])
    case 165:
    ...
    case 239:
      return MenstrualCycleRecordDto.fromList(self.readValue() as! [Any?])
    default:
...
private class HealthConnectorPlatformApiPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? HealthConnectorErrorCodeDto {
      ...
      super.writeByte(143)
      super.writeValue(value.rawValue)
    } else if let value = value as? Vo2MaxUnitDto {
      super.writeByte(144)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(163)
      super.writeValue(value.toList())
    } else if let value = value as? Vo2MaxDto {
      super.writeByte(164)
      super.writeValue(value.toList())
      ...
      super.writeByte(238)
      super.writeValue(value.toList())
    } else if let value = value as? MenstrualCycleRecordDto {
      super.writeByte(239)
      super.writeValue(value.toList())
    } else {
