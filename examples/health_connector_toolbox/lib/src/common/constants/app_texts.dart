...
abstract final class AppTexts {
  ...
  static const String toolboxSubtitle =
      'Inspect and manage your on-device health data using the Health '
      'Connector SDK';
  ...
  static String getLabel(HealthDataType type) {
    return switch (type) {
      ...
      SkinTemperatureDeltaSeriesDataType() => 'Skin Temperature Delta Series',
  ...
  // Pregnancy Test
  static const String pregnancyTestDescription =
      'Pregnancy test results to detect pregnancy';
