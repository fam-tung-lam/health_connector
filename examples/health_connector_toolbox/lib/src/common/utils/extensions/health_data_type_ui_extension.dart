...
extension HealthDataTypeUI on HealthDataType {
  ...
  String get displayName {
    return switch (this) {
      ...
      SkinTemperatureDeltaSeriesDataType _ => 'Skin Temperature Delta Series',
      ...
      MenstruationPeriodDataType _ => AppTexts.menstruationPeriod,
      ...
      PeakExpiratoryFlowRateDataType _ => AppTexts.peakExpiratoryFlowRate,
  ...
  String get description {
    return switch (this) {
      ...
      PeakExpiratoryFlowRateDataType _ =>
        AppTexts.peakExpiratoryFlowRateDescription,
      ...
      MenstruationPeriodDataType _ => 'Record of menstruation periods',
      ...
      IrregularMenstrualCycleEventDataType _ =>
        AppTexts.irregularMenstrualCycleEventDescription,
      InfrequentMenstrualCycleEventDataType _ =>
  ...
  IconData get icon {
    return switch (this) {
      ...
      SkinTemperatureDeltaSeriesDataType _ => AppIcons.temperature,
      ...
      PeakExpiratoryFlowRateDataType _ => AppIcons.air,
      ...
      MenstruationPeriodDataType _ => AppIcons.waterDrop,
...
extension HealthDataTypeUIFormExtension on HealthDataType {
  ...
  String get fieldLabel {
    return switch (runtimeType) {
      ...
      const (PeakExpiratoryFlowRateDataType) => AppTexts.valueWithUnit(
        AppTexts.peakExpiratoryFlowRate,
        AppTexts.literPerSecond,
      ),
  ...
  String? get fieldSuffix {
    return switch (runtimeType) {
      ...
      const (PeakExpiratoryFlowRateDataType) => AppTexts.literPerSecond,
