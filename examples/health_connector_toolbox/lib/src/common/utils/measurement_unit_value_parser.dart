...
abstract class MeasurementUnitValueParser {
  ...
  static MeasurementUnit parseValue({
    ...
    return switch (forDataType) {
      ...
      SkinTemperatureDeltaSeriesDataType() => _parseTemperature(value),
      ...
      HeadphoneAudioExposureDataType() => _parseDoubleNumber(value),
      ...
      ProgesteroneTestDataType() => throw UnsupportedError(
        '$PregnancyTestDataType is a complex type with test result, '
        'cannot be parsed from a single string input.',
      ),
      ...
      EnvironmentalAudioExposureEventDataType() => throw UnsupportedError(
        '$EnvironmentalAudioExposureEventDataType is a read-only event record, '
        'cannot be parsed from a single string input.',
      ),
      HeadphoneAudioExposureEventDataType() => throw UnsupportedError(
        '$HeadphoneAudioExposureEventDataType is a read-only event record, '
        'cannot be parsed from a single string input.',
      ),
      ...
      PersistentIntermenstrualBleedingEventDataType() => throw UnsupportedError(
        '$PersistentIntermenstrualBleedingEventDataType is a read-only event '
        'record, cannot be parsed from a single string input.',
      ),
      ProlongedMenstrualPeriodEventDataType() => throw UnsupportedError(
        '$ProlongedMenstrualPeriodEventDataType is a read-only event record, '
        'cannot be parsed from a single string input.',
      ),
    };
  }
