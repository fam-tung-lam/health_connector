...
import 'package:health_connector_toolbox/src/features/read_health_records/widgets/health_record_list_tiles/interval_health_record_list_tiles/insulin_delivery_list_tile.dart';
...
import 'package:health_connector_toolbox/src/features/read_health_records/widgets/health_record_list_tiles/interval_health_record_list_tiles/irregular_menstrual_cycle_event_record_list_tile.dart';
...
import 'package:health_connector_toolbox/src/features/read_health_records/widgets/health_record_list_tiles/series_health_record_list_tiles/heartbeat_series_list_tile.dart';
...
import 'package:health_connector_toolbox/src/features/read_health_records/widgets/health_record_list_tiles/series_health_record_list_tiles/skin_temperature_delta_series_list_tile.dart';
...
final class HealthRecordListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tile = switch (record) {
      ...
      final HeartbeatSeriesRecord r => HeartbeatSeriesTile(
        record: r,
        onDelete: onDelete,
      ),
      ...
      final LowCardioFitnessEventRecord r =>
        LowCardioFitnessEventRecordListTile(
          record: r,
        ),
      ...
      final HeadphoneAudioExposureEventRecord r =>
        SimpleIntervalMeasurementListTile<HeadphoneAudioExposureEventRecord>(
          record: r,
          icon: AppIcons.volume,
          titleBuilder: (_) => 'Headphone Audio Exposure Event',
          valueExtractor: (_) => Number.zero,
          onDelete: onDelete,
        ),
      final EnvironmentalAudioExposureRecord r =>
        SimpleIntervalMeasurementListTile<EnvironmentalAudioExposureRecord>(
          record: r,
          icon: AppIcons.volume,
          titleBuilder: (r) =>
              '${r.aWeightedDecibel.value.toStringAsFixed(1)} dB',
      ...
      final ExerciseTimeRecord r =>
        SimpleIntervalMeasurementListTile<ExerciseTimeRecord>(
          ...
          icon: AppIcons.time,
          titleBuilder: (r) =>
              '${r.exerciseTime.inMinutes.toStringAsFixed(0)} min',
      ...
      final SkinTemperatureDeltaSeriesRecord r =>
        SkinTemperatureDeltaSeriesTile(
          record: r,
          onDelete: onDelete,
        ),
      ...
      final ElectrodermalActivityRecord r => ElectrodermalActivityTile(
        record: r,
        onDelete: onDelete,
      ),
      final InsulinDeliveryRecord r => InsulinDeliveryTile(
        record: r,
        onDelete: onDelete,
      ),
      final InhalerUsageRecord r => InhalerUsageTile(
        record: r,
        onDelete: onDelete,
      ),
    };
