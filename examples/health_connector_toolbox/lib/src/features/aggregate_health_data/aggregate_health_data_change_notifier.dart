...
final class AggregateDataChangeNotifier extends ChangeNotifier {
  ...
  static AggregateRequest<MeasurementUnit> _buildRequest({
    ...
    return switch (dataType) {
      ...
      InsulinDeliveryDataType() => _buildSum(
        () => HealthDataType.insulinDelivery.aggregateSum(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ...
      ExerciseTimeDataType() => _buildSum(
        () => HealthDataType.exerciseTime.aggregateSum(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ),
      MoveTimeDataType() => _buildSum(
        () => HealthDataType.moveTime.aggregateSum(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ...
      StandTimeDataType() => _buildSum(
        () => HealthDataType.standTime.aggregateSum(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ),
      WalkingSteadinessDataType() => _buildAvgMinMax(
        () => HealthDataType.walkingSteadiness.aggregateAvg(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.walkingSteadiness.aggregateMin(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.walkingSteadiness.aggregateMax(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ...
      WalkingAsymmetryPercentageDataType() => _buildAvgMinMax(
        () => HealthDataType.walkingAsymmetryPercentage.aggregateAvg(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.walkingAsymmetryPercentage.aggregateMin(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.walkingAsymmetryPercentage.aggregateMax(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ),
      WalkingDoubleSupportPercentageDataType() => _buildAvgMinMax(
        () => HealthDataType.walkingDoubleSupportPercentage.aggregateAvg(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.walkingDoubleSupportPercentage.aggregateMin(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.walkingDoubleSupportPercentage.aggregateMax(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ...
      AtrialFibrillationBurdenDataType() => _buildAvgMinMax(
        ...
        () => HealthDataType.atrialFibrillationBurden.aggregateMin(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.atrialFibrillationBurden.aggregateMax(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ...
      HeadphoneAudioExposureEventDataType() => throw UnsupportedError(
        'Headphone Audio Exposure Event is not supported for aggregation',
      ),
      ...
      PeakExpiratoryFlowRateDataType() => _buildAvgMinMax(
        () => HealthDataType.peakExpiratoryFlowRate.aggregateAvg(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.peakExpiratoryFlowRate.aggregateMin(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.peakExpiratoryFlowRate.aggregateMax(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ...
      WalkingHeartRateAverageDataType() => _buildAvgMinMax(
        ...
        () => HealthDataType.walkingHeartRateAverage.aggregateMin(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.walkingHeartRateAverage.aggregateMax(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
      ),
      HeartRateRecoveryOneMinuteDataType() => _buildAvgMinMax(
        () => HealthDataType.heartRateRecoveryOneMinute.aggregateAvg(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.heartRateRecoveryOneMinute.aggregateMin(
          startTime: startTime,
          endTime: endTime,
        ),
        () => HealthDataType.heartRateRecoveryOneMinute.aggregateMax(
          startTime: startTime,
          endTime: endTime,
        ),
        metric,
